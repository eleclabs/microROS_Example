...
// Encoder Pins
#define LeftEncoder_C1 34
#define LeftEncoder_C2 35
#define RightEncoder_C1 26
#define RightEncoder_C2 27

// Pin Definitions
#define PWMA 32     //PWMA Motor1
#define IN1_PIN 33  //left forward
#define IN2_PIN 25  //left backward

#define PWMB 13     //PWMB Motor2
...
void setup() {
  ...
  set_microros_wifi_transports("EMB5325", "cdti12345", "192.168.1.121", 8888);
...
void loop() {
  //spd = map(analogRead(39), 0, 4095, 255, 0);
  delay(100);
